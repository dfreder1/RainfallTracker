...
for item in station_id:       
	...
	print dategrabbed +'  '+rainsofarseason
        if _platform == "linux" or _platform == "linux2":
            e = '/var/www/html/projects/Rainfall/2016-17/RainfallTracker/data/gauge'+item
            f = open(e,'a')
            g = '/var/www/html/projects/Rainfall/2016-17/RainfallTracker/data/gauge'+item+'backup'
            shutil.copy(e,g)
